...
class AfricasTalkingGateway
{
    ...
    // {
    //     $this->_username     = config('sms.username');
    //     $this->_apiKey       = config('sms.api_key');
    //     //$this->from_         = config('sms.from');
    ...
    //Messaging methods
    public function sendMessage($to_, $message_, $from_ = 'RAFIKIBET', $bulkSMSMode_ = 1, Array $options_ = array())
    {
